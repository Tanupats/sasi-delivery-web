                    ...
                    return (
                      <React.Fragment key={index}>
                        <Col
                          ...
                          className="mb-2"
                          onClick={() =>
                            item.status === 1 && onSelectMenu(item)
                          }
                        >
                  ...
                  <>
                    <div className="text-center">
                      <Alert variant="danger">
                        ยังไม่มีรายการสินค้า สามารถเพิ่มได้ที่
                        เมนูจัดการร้านค้าของคุณ
                      </Alert>
                    </div>{" "}
                  </>
                )}
                      ...
                      <Row className="order-type when-print">
                        ...
                        style={{color: activeTypeRecipe === "เสิร์ฟในร้าน" ? "#fff" : "#000000", border: `2px solid ${activeTypeRecipe === "เสิร์ฟในร้าน" ? "#ff7a00" : "gray"}`, backgroundColor: activeTypeRecipe === "เสิร์ฟในร้าน" ? "#ff7a00" : "#fff"}}
                            ...
                            onClick={() => {
                              ...
                              setName("ทานที่ร้าน");
                              setActiveTypeRecipe("เสิร์ฟในร้าน");
                            }}
                          >
                            ทานที่ร้าน
                          </Button>
                        ...
                        <Col md={4} xs={4}>
                          <Button
                            ...
                            onClick={() =>
                              setDefaultMenu({
                                ...defaultMenu,
                                foodname: defaultMenu.foodname + "พิเศษ",
                                Price: parseInt(defaultMenu.Price) + 10,
                              })
                            }
                          >
                            {" "}
                ...
                <Row>
                  ...
                  <Col md={8} xs={8}>
                    <Form.Control
                      ...
                      value={quantity}
                      onChange={(e) => {
                        updateQuantity(newId, e.target.value);
                      }}
                    />
                  </Col>
                  <Col md={2} xs={2}>
